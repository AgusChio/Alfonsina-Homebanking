...
//
//			Card cardMelba = new Card(melba.getFirstName() + " " + melba.getLastName(), "4235 5643 6785 8975", 457, LocalDate.now(), LocalDate.now().plusYears(5), CardType.DEBIT , CardColor.GOLD, melba,true);
//			cardRepository.save(cardMelba);
//			Card cardMelbaTwo = new Card(melba.getFirstName() + " " + melba.getLastName(), "4367 8754 9087 7896", 875, LocalDate.now(), LocalDate.now().plusYears(5), CardType.CREDIT , CardColor.TITANIUM, melba,true);
//			cardRepository.save(cardMelbaTwo);
//			Card cardMelbaThree = new Card(melba.getFirstName() + " " + melba.getLastName(), "4562 0788 9956 5437", 657, LocalDate.now(), LocalDate.now().plusYears(5), CardType.CREDIT , CardColor.SILVER, melba,true);
//			cardRepository.save(cardMelbaThree);
//			Card cardJack = new Card(jack.getFirstName() + " " + jack.getLastName(), "4467 2878 9912 2304", 902, LocalDate.now(), LocalDate.now().plusYears(5), CardType.CREDIT , CardColor.SILVER, jack,true);
